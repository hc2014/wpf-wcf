...
namespace AdminManager.BLL
{
	...
	/// 1
	/// </summary>
	public partial class SpreadLevelInfoBLL
	{
        private readonly AdminManager.DAL.SpreadLevelInfoDAL dal = new AdminManager.DAL.SpreadLevelInfoDAL();
        public SpreadLevelInfoBLL()
		{}
		#region  BasicMethod
